 ...
 * @author Shali
 */
public class AvailableVehicles extends javax.swing.JDialog {

    /**
     * Creates new form AvailableVehicles
     */
    public AvailableVehicles(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        SQL n2 = new SQL();
         n2.vehicleNoty(jTable121,"Available");
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AvailableVehicles dialog = new AvailableVehicles(new javax.swing.JFrame(), true);
